...
// Create a client-side only Lottie component
const ClientLottie = ({ animationData, className }) => {
    ...
    if (!isMounted) {
        return <div className={`bg-gray-100 animate-pulse ${className}`}></div>;
    }
        ...
        <div>
            <div className="text-center lg:text-7xl text-3xl p-10 lg:text-center lg:py-[120px] lg:mt-[-130px] lg:mb-[30px]">
                ...
                <div className='flex justify-center'>
                    <ClientLottie animationData={HomeImg} className='h-[400px] lg:h-[650px] mt-[-60px]'/>
                </div>
                <div className="lg:text-4xl text-xl lg:my-10 lg:mt-[100px]">
                    <b>CoinCoach isn't just another financial advice site; it's a learning companion</b>
                </div>
                <Link href="#crs" className='inline-block bg-[#006af9] text-4xl text-white mt-[-10px] mr-[20px] px-5 py-3 lg:rounded-full rounded-lg'>
                    Explore our Courses!
                </Link>
            </div>

            <div className='grid justify-center lg:grid-cols-2 grid-cols-1 lg:mt-[100px] h-[700px] lg:mx-[100px] bg-[#301934] rounded-3xl border-[1px]'>
                <div className='caveat-font text-center text-white inter lg:text-4xl text-xl lg:mt-[325px] lg:ml-[175px]'>
                    Save Today, Secure Tomorrow, <br/>Your Future Starts with Small Steps!
                </div>
                <ClientLottie animationData={Savings} className='lg:h-[900px] mt-[-100px] h-[300px] lg:mr-[175px]'/>
            </div>

            <div>
                <div className='lg:text-6xl text-4xl p-3 lg:text-center inter lg:mt-[120px]'><b>Why Use CoinCoach?</b></div>
                <div className='grid grid-cols-1 lg:grid-cols-2 lg:pl-[0px]'>
                    <ClientLottie animationData={Games} className='lg:w-[500px] lg:h-[500px] mt-[100px] lg:ml-[150px] mx-auto'/>
                    <div className='lg:mt-[80px] pt-[180px] text-5xl text-center inter font-bold px-[30px] bg-orange-400 rounded-ss-[150px] rounded-ee-[150px] py-[80px]'>
                        Gamified Learning 
                        <div className='mt-[10px] text-xl font-semibold'>For Fun And Engagement</div>
                ...
                <div className='grid grid-cols-1 lg:grid-cols-2'>
                    <div className='lg:mt-[0px] pt-[180px] text-5xl text-center font-bold inter px-[30px] bg-orange-400 rounded-ss-[150px] rounded-ee-[150px] py-[80px]'>
                        ...
                        <div className='mt-[10px] text-xl font-semibold'>for Real Results</div> 
                        <div className='text-xl font-thin'>
                            Learning about finances doesn't have to be boring! CoinCoach turns complex topics into interactive games, quizzes, and challenges, so you can stay motivated and retain what you learn
                        </div>
                    </div>
                    <ClientLottie animationData={Finplan} className='lg:w-[500px] lg:h-[500px] mt-[50px] lg:ml-[150px] mx-auto'/>
                </div>
            </div>
            ...
            <div className='bg-gradient-to-r from-[rgba(169,61,225,1)] to-[rgba(255,113,77,1)] mx-[50px] lg:h-[500px] lg:rounded-full rounded-lg inter lg:mt-[-20px]'>
                ...
                <div className='flex justify-center'>
                    <Link href="/signup" className='bg-black hover:bg-white text-white hover:text-black my-[100px] py-3 px-10 mt-[20px] text-2xl rounded-xl'>
                        Try For FREE!
                    </Link>
                </div>
            </div>
            ...
            <div>
                <div>
                    <Link href="/apps" className='inline-block px-4 py-2 bg-blue-500 text-white rounded-lg hover:bg-blue-600'>
                        Try this game
                    </Link>
                </div>
            </div>

            <footer className='bg-[#301934] lg:mt-[100px] rounded-ss-full rounded-se-full inter'>
